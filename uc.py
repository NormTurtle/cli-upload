...
class _MultipartStream:
    ...
    def read(self, n=-1):
        ...
        if self._progress_buffer > 0 and (
            self._progress_buffer >= 512 * 1024 or self._idx >= len(self._parts)
        ):
            add_progress(self._filename, self._progress_buffer)
            self._progress_buffer = 0
    ...
    def seek(self, offset):
        ...
        # Only rollback what was actually reported globally
        actual_reported = file_progress_reported - self._progress_buffer
